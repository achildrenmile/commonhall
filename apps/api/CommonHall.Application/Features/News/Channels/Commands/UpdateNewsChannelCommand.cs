...
public sealed record UpdateNewsChannelCommand : IRequest<NewsChannelDto>
{
...
public sealed class UpdateNewsChannelCommandValidator : AbstractValidator<UpdateNewsChannelCommand>
{
    public UpdateNewsChannelCommandValidator()
    {
        RuleFor(x => x.Id)
