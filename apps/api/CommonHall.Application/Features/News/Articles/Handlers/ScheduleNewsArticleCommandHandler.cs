...
public sealed class ScheduleNewsArticleCommandHandler : IRequestHandler<ScheduleNewsArticleCommand, NewsArticleDto>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUser _currentUser;
    private readonly UserManager<User> _userManager;

    public ScheduleNewsArticleCommandHandler(
    ...
    public async Task<NewsArticleDto> Handle(ScheduleNewsArticleCommand request, CancellationToken cancellationToken)
    {
